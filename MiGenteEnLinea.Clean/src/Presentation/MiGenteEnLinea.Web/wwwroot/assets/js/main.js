...
fullscreenBtn.addEventListener('click', () => {
    // Verificar si no estamos en modo pantalla completa
    if (!document.fullscreenElement) {
        ...
        // Salir del modo pantalla completa si ya estamos en él
...
function openModalContratacion() {
    var modal = document.getElementById('modalContratacion');
...
function openModalPagoEmpleado() {
        ...
        html: `
            <div style="display: flex; flex-direction: column; align-items: center;">
                <img src="https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExZ21zYmY5d2Zoc2UxaGp1dnd1OXh5dnhqazBqZ2FoM2N5cmozbW9qZSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/tVFCT2uq9HL0M58KBd/giphy.webp" 
                    alt="Espere" style="width: 150px; height: 150px;" />
                <p style="margin-top: 15px;">Por favor espere mientras procesamos su suscripci\u00F3n.</p>
            </div>
        `,
